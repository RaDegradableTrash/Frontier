...
public static class PlayableSceneRulesTests
{
    public static int Main()
    {
        ...
        AssertTrue(PlayableSceneRules.PlayerHandAnchor.z < PlayableSceneRules.PlayerCommandRowZ, "Collapsed player hand should sit partly outside the bottom of the view.");
        AssertTrue(PlayableSceneRules.PlayerHandAnchor.z < PlayableSceneRules.PlayerCommandRowZ - 0.15f, "Collapsed player hand should remain partly outside the bottom of the view.");
        AssertTrue(PlayableSceneRules.PlayerHandAnchor.z > -4.35f, "Collapsed player hand should leave enough card face visible to understand it is a hand rail.");
        ...
        AssertTrue(PlayableSceneRules.HandHintPosition.z > PlayableSceneRules.PlayerHandAnchor.z, "Hand hint should stay visible above the tucked cards.");
        ...
        AssertTrue(PlayableSceneRules.PileLabelColor.grayscale < 0.35f, "Pile labels should use dark military UI color, not bright pastel text.");
        ...
        AssertTrue(PlayableSceneRules.KreditDisplayCharacterSize >= 0.052f && PlayableSceneRules.KreditDisplayCharacterSize <= 0.065f, "Kredit counters should be large enough to read as Kards-like side badges.");
        AssertTrue(PlayableSceneRules.KreditDisplayBackingScale.x >= 0.8f && PlayableSceneRules.KreditDisplayBackingScale.x <= 0.95f, "Kredit counters should be prominent side badges, not tiny table text.");
        ...
        AssertTrue(PlayableSceneRules.FloatingTextCharacterSize <= 0.08f, "Action feedback text should not cover the whole board.");
        ...
        AssertTrue(PlayableSceneRules.HandCardScale >= 0.95f && PlayableSceneRules.HandCardScale < 1.05f, "Hand cards should be larger and easier to read while still fitting below the board.");
